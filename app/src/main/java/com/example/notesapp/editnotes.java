    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msaveeditnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(editnotes.this, "savebutton click", Toast.LENGTH_SHORT).show();
                ...
                if(newtitle.isEmpty()||newcontent.isEmpty()){
                    ...
                    documentReference.set(note).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(editnotes.this, "Note is updated", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(new Intent(editnotes.this,notesActivity.class)));
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(editnotes.this, "Fail to update", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
